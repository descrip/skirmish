...
$f3->route('GET /problems/@slug/submit', '\Controllers\SubmissionController->submit');
$f3->route('GET /problems/@slug/all-submissions', '\Controllers\ProblemController->allSubmissions');
$f3->route('GET /problems/@slug/best-submissions', '\Controllers\ProblemController->bestSubmissions');
$f3->route('GET /problems/@slug/your-submissions', '\Controllers\ProblemController->yourSubmissions');
$f3->route('GET /submit', '\Controllers\SubmissionController->submit');
